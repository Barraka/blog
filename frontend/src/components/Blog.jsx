...
function Blog(props) {
    ...
    return (
        <div className='blogWrapper'>
            ...
            <button onClick={e=>console.log('debug comments: ', props.postComments)}>Debug</button>

            {displayComments}

            {/* <Comment postComments={props.postComments} displayComments={displayComments} addComment={props.addComment} deleteComment={props.deleteComment}   id={props.data._id} user={props.user} token={props.token} data={props.data}/> */}
